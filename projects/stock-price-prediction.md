...
labels:
  ...
  - ARIMA
  - Google Colab
summary: A time series forecasting model predicting Google stock prices using ARIMA and LSTM techniques, achieving ~86% accuracy on historical Yahoo Finance data.
---
